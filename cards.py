...
def addCard(newCard,dealtCardAttribute):       
...
ttk.Button(mainframe, text="stripes", command=lambda: defineFill("stripes")).grid(column=4, row=5, sticky=W)
...
ttk.Button(mainframe, text="Add Card", command=lambda: addCard(newCard, dealtCardAttribute)).grid(column=6, row=7, sticky=W)
